...
/* harmony export (immutable) */ __webpack_exports__["b"] = GET_DOM_STYLES;
...
const GET_SELECTED_ITEM_TEMPLATE = (option, index, filteredOptions, parentReferences) => {
    ...
    const closeButton = parentReferences.multiple ? `<div class="selector-helper"><span class="selector-icon" data-index="${index}"></span></div>` : ``;
...
const GET_DROPDOWN_GROUP_TEMPLATE = (option, index, filteredOptions, parentReferences) => {
...
/* harmony export (immutable) */ __webpack_exports__["c"] = GET_DROPDOWN_GROUP_TEMPLATE;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__selector_selected_items_component__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__selector_dropdown_items_component__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selector_component__ = __webpack_require__(364);
...
class SelectorSelectedItemsComponent {
    constructor($log, debug) {
        ...
        this.getRenderableItems = items => {
            return `${items.map((currentValue, index, array) => `${Object(__WEBPACK_IMPORTED_MODULE_0__utils__["e" /* GET_SELECTED_ITEM_TEMPLATE */])(currentValue, index, array, this._parentReferences)}`).join(' ')}`;
        };
        SelectorSelectedItemsComponent.prototype.link = (scope, element, attrs) => {
            __WEBPACK_IMPORTED_MODULE_1_rxjs__["Observable"].fromEvent(element[0], 'click').subscribe(e => {
                if (e.type === 'click') {
            ...
            if (scope.input) {
                ...
                this._subscribers.push(scope.input.subscribe(inputData => {
                    if (inputData.selectedValues && inputData.selectedValues.length) {
                        if (!this._parentReferences.hasOwnProperty('groupAttr') || !this._parentReferences.hasOwnProperty('getObjValue') || !this._parentReferences.hasOwnProperty('unset') || !this._parentReferences.hasOwnProperty('multiple') || !this._parentReferences.hasOwnProperty('disabled')) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SelectorSelectedItemsComponent;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(39), __webpack_require__(312)))
...
class SelectorDropdownItemsComponent {
    constructor($log, debug) {
        ...
        this.getRenderableItems = (items, highlighted) => {
            return `${items.map((currentValue, index, array) => `${Object(__WEBPACK_IMPORTED_MODULE_0__utils__["c" /* GET_DROPDOWN_GROUP_TEMPLATE */])(currentValue, index, array, this._parentReferences)}${Object(__WEBPACK_IMPORTED_MODULE_0__utils__["d" /* GET_DROPDOWN_ITEM_TEMPLATE */])(currentValue, index, array, this._parentReferences, highlighted)}`).join(' ')}`;
        };
        SelectorDropdownItemsComponent.prototype.link = (scope, element, attrs) => {
            __WEBPACK_IMPORTED_MODULE_1_rxjs__["Observable"].merge(__WEBPACK_IMPORTED_MODULE_1_rxjs__["Observable"].fromEvent(element[0], 'mouseenter'), __WEBPACK_IMPORTED_MODULE_1_rxjs__["Observable"].fromEvent(element[0], 'click')).subscribe(e => {
                if (e.type === 'mouseover') {
                    const index = parseInt(e.srcElement.getAttribute('data-index'));
